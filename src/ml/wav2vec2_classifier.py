...
TRAIN_FINAL = True #True: train on train+devel set
...
#print(len(my_dict_train['file']), len(my_dict_dev['file']))
if TRAIN_FINAL:
...
#Eval dev and test:
print("Devel:\n")
result_folder = f"./results/wav2vec2_traindev/"
...
print(cm)
print(f"UAR: {uar:.2%} ({ci_low:.2%} - {ci_high:.2%}), ACC: {acc:.2%}") # ({ci_low:.2%} - {ci_high:.2%})
